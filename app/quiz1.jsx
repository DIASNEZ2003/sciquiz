...
const Quiz1 = () => {
  ...
  useEffect(() => {
    ...
    if (activeUid) {
      ...
      if (localData && localData.lesson1Completed === 1) {
        initialTime = 0;
        setTimeLeft(0);
      }
    }
  ...
  const handleContinue = async () => {
    ...
    if (state.isConnected) {
      try {
        ...
        await update(userRef, { "lesson1/completed": true });
      } catch (error) {
        updateLocalProgress(activeUid, "lesson1Completed", true);
      }
    } else {
  ...
  return (
    <SafeAreaView className="flex-1 bg-blue-800">
      ...
      <View className="flex-1 px-8 justify-center items-center">
        ...
        >
          <View className="bg-blue-950/90 border-2 border-blue-400 rounded-3xl p-8 w-full max-w-[400px] shadow-2xl shadow-blue-500/30">
