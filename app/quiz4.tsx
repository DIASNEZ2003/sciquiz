...
const Quiz4 = () => {
  ...
  useEffect(() => {
    ...
    if (activeUid) {
      ...
      if (localData && localData.lesson4Completed === 1) {
        initialTime = 0;
        setTimeLeft(0);
      }
    }
  ...
  const handleContinue = async () => {
    ...
    if (state.isConnected) {
      try {
        ...
        console.log("Quiz 4: Sync to Firebase successful");
      } catch (error) {
        updateLocalProgress(activeUid, "lesson4Completed", true);
      }
    } else {
      ...
      <View className="flex-1 px-8 justify-center items-center">
        ...
        >
          <View className="mb-10 items-center justify-center relative">
            ...
            >
              <View className="bg-white rounded-2xl p-2 py-4 shadow-xl min-w-[120px]">
                <Text className="text-blue-900 font-bold text-center text-[10px] leading-3">
                  {timeLeft > 0
                    ? `Read carefully...\n${timeLeft}s remaining`
                    : "Already know Genetics?!\nTap Next."}
                </Text>
                <View
                  style={{
                    position: "absolute",
          ...
          <View className="flex-1 bg-blue-950/90 border-2 border-blue-400 rounded-3xl w-full max-w-[400px] shadow-2xl shadow-blue-500/30 overflow-hidden">
            ...
            >
              ...
              <View className="flex-row items-start mb-5">
                ...
                <Text className="text-white text-base font-medium flex-1 leading-6">
                  Each parent contributes one allele for every trait.
                </Text>
              </View>
              ...
              <View className="flex-row items-start mb-5">
                ...
                <Text className="text-white text-base font-medium flex-1 leading-6">
                  Sometimes, a child may look different from one or both
                  parents.
                </Text>
              </View>
              ...
              <View className="flex-row items-start mb-5">
                ...
                <Text className="text-white text-base font-medium flex-1 leading-6">
                  This does not mean a mistake happened.
                </Text>
              </View>
              ...
              <View className="flex-row items-start mb-2">
                ...
                <Text className="text-white text-base font-medium flex-1 leading-6">
                  Genetics follows predictable patterns that can explain these
                  differences.
                </Text>
              </View>
            </ScrollView>
              ...
              >
                ...
                >
                  <Text className="text-blue-950 font-black text-xl tracking-widest uppercase">
                    {timeLeft > 0 ? `WAIT ${timeLeft}s` : "Next"}
                  </Text>
                </View>
              </TouchableOpacity>
            </View>
